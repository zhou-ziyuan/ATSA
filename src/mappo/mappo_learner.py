...
class MAPPO:
    def __init__(self, args):
        self.n_actions = args.obs_shape  # Perturbation dimension produced by the actor.
        self.n_agents = args.n_agents  # Number of agents in the environment.
        self.state_shape = args.obs_shape  # Observation dimension used as the actor input.
    ...
    def train(self, batch:EpisodeBatch, t_env:int,episode_num:int ):
        ...
        # The perturbation policy is modeled as a Gaussian distribution.
    ...
    def compute_advantage(self,gamma, lmbda, td_delta):
        ...
        for delta in np.flip(td_delta,1).swapaxes(0,1):
