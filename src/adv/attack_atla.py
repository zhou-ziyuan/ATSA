...
def get_state(model, batch, actions, opt, attack_config, t, t_env, hidden_state, verbose=False, env_id=""):
    ...
    X_per = Variable(agent_inputs.data, requires_grad=True)  # Placeholder for the perturbed observation.

    # TODO: use the MAPPO actor to generate an observation perturbation.
