...
class FOPMixer(nn.Module):
    """Mixer used by the adversary in FOP-style training."""
    ...
    def forward(self, agent_qs, states, actions=None, vs=None):
        ...
        # Distribute the state-value baseline evenly across agents before mixing.
    ...
    def lambda_weight(self, states, actions):
        """Compute per-agent mixing weights conditioned on state and action."""
